...
// // console.log(countWordsInString("ilovejs"));

// function longestWord(str) {
//   let strArr = str.split(" ");
//   let longestWordOutput = "";
//   for (let i = 0; i < strArr.length; i++) {
//     let longest = "";
//     for (let j = 0; j < strArr[i].length; j++) {
//       longest += strArr[i][j];
//     }
//     if (longest.length > longestWordOutput.length) {
//       longestWordOutput = longest;
//       longest = "";
//     }
//   }
//   return longestWordOutput;
// }

// // console.log(longestWord("Javascript is awesomessssssss"));
